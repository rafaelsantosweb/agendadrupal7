...
<div class="listagem-resultados">
    <div class="col-md-12">
		...
		<?php $ano = date('Y', $node[$key]->field_data_do_evento['und'][0]['value']); ?>
		
		<?php if($mes == $mes_field && $node[$key]->status == 1 && $ano == 2019): ?>
			<div class="box-eventos" data-filter="-eventos" data-tipo-evento="<?php print $node[$key]->field_tipo_de_evento['und'][0]['tid'];?>">
				...
				<p class="ev-descricao">
					<a href="node/<?php print $node[$key]->nid;?>"><?php print $node[$key]->title;?></a>
				</p>
			</div>
		<?php endif; ?>
        <?php endforeach; ?>
